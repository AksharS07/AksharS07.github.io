...
(function githubRepos() {
  ...
  const FEATURED_PROJECTS = {
    "dynamic-island-browser": {
      ...
      firefoxUrl: "https://addons.mozilla.org/en-US/firefox/addon/dynamic-island-for-web/",
      features: [
        {
  ...
  function buildFeaturedCard(repo, langs, meta) {
    ...
    const edgeBtn = meta.edgeUrl
      ? `<a class="featured-link-btn store" href="${meta.edgeUrl}" target="_blank" rel="noopener noreferrer">
    ...
    const firefoxBtn = meta.firefoxUrl
      ? `<a class="featured-link-btn store" href="${meta.firefoxUrl}" target="_blank" rel="noopener noreferrer">
